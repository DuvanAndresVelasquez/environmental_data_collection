...
import com.la.veolia.EditDatesTableFourMaterialCheck;
...
public class ListRegistroAdapterFourMaterialCheck extends RecyclerView.Adapter<ListRegistroAdapterFourMaterialCheck.RegistroTableFourMaterialCheckViewHolder> {
    ArrayList<RegistroTableFourMaterialCheck> listThreeMaterialCheck;
    public ListRegistroAdapterFourMaterialCheck(ArrayList<RegistroTableFourMaterialCheck> listThreeMaterialCheck) {
    ...
    @NonNull
    @Override
    public RegistroTableFourMaterialCheckViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_material_check, null,
                false);
        return new ListRegistroAdapterFourMaterialCheck.RegistroTableFourMaterialCheckViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RegistroTableFourMaterialCheckViewHolder holder, int position) {
        ...
        holder.c3.setText("Cantidad: "+ listThreeMaterialCheck.get(position).getCantidad());
    ...
    public class RegistroTableFourMaterialCheckViewHolder extends RecyclerView.ViewHolder {
        TextView c1, c2, c3, c4, c5, c6, c7;

        public RegistroTableFourMaterialCheckViewHolder(@NonNull View itemView) {
            super(itemView);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Bien.setMessage("Edita los datos de este regístro. (Acción no programada)")
                            .setCancelable(true)
                            .setPositiveButton("Editar", new DialogInterface.OnClickListener() {
                                @RequiresApi(api = Build.VERSION_CODES.M)
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    Intent edit = new Intent(context, EditDatesTableFourMaterialCheck.class);
                                    ...
                                    edit.putExtra("can", listThreeMaterialCheck.get(getAdapterPosition()).getCantidad());
